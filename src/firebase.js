...
export const getUserType = (email) => {
  ...
  if (email === 'mbathamathamsanqa@gmail.com' || email === 'mphelanekgethego20060325@gmail.com' || email === '2833644@students.wits.ac.za') return 'admin';
