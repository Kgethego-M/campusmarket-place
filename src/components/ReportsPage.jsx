  ...
  return (
    <div
      ...
      style={{
        ...
        padding: "24px 64px",   /* 64px sides = room for the ‹ › buttons */
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          fontSize: "0.78rem", marginTop: 8, fontFamily: "inherit",
        }}>
          {idx + 1} / {photos.length}
        </div>
          ...
          <tbody>
            {users.map((u, i) => {
              ...
              return (
                <tr
                  key={u.id}
                  style={{ borderBottom: i < users.length - 1 ? "1px solid #f1f5f9" : "none", transition: "background 0.12s" }}
