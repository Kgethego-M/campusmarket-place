...
import UserReviews from "./SellerReviews";
...
const Profile = () => {
  ...
  const [currentUserId, setCurrentUserId]   = useState(null); // track logged-in uid
  ...
  useEffect(() => {
    ...
    if (tab && ['history', 'listings', 'offers', 'reviews'].includes(tab)) setActiveTab(tab);
    if (highlight) {
    ...
    <div className={styles.profileContainer}>
      ...
      <div className={styles.tabsSection}>
        <div className={styles.tabs}>
          ...
          {/* ✅ NEW REVIEWS TAB */}
          <button className={`${styles.tab} ${activeTab === 'reviews'  ? styles.activeTab : ''}`} onClick={() => setActiveTab('reviews')}><i className="fas fa-star" /> Reviews</button>
        </div>
        ...
        {/* ✅ REVIEWS TAB — shows buyer & seller reviews for logged-in user */}
        {activeTab === 'reviews' && (
          <div className={styles.tabContent}>
            {currentUserId ? (
              <UserReviews reviewedUserId={currentUserId} />
            ) : (
              <div className={styles.emptyState}>
