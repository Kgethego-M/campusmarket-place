    ...
    try {
      ...
      if (selectedRole === 'student') {
        ...
        if (!allowed) {
          await signOut(auth);
          setShowPopup(false);
          show(`Student sign-up requires a @students.wits.ac.za email. You used: ${email}`, true);
          return;
        }
        ...
        if (!allowed) {
          await signOut(auth);
          setShowPopup(false);
          show(`Staff sign-up requires a @wits.ac.za email. You used: ${email}`, true);
          return;
        }
        ...
        if (!allowed) {
          await signOut(auth);
          setShowPopup(false);
          show(`Admin sign-up requires an approved email address. You used: ${email}`, true);
          return;
        }
      }
