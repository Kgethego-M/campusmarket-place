...
export default function ProfileListingCard({
    ...
    const displayListingType = normaliseListingType(listingType);
                    ...
                    <div className={styles.drawerForm}>
                        ...
                        <div className={styles.fieldGroup}>
                            ...
                            <div className={styles.typeToggle}>
                                {listingTypeOptions.map((type) => {
                                    const currentVal = normaliseListingType(editData.listingType) || displayListingType;
                                    return (
                                        <button
                                            key={type}
                                            type="button"
                                            className={`${styles.typeOption} ${currentVal === type ? styles.typeOptionActive : ""}`}
                        ...
                        <div className={styles.fieldGroup}>
                            ...
                            <textarea
                                ...
                                placeholder="e.g., Brand, model, size, color, included items..."
                                rows={4}
